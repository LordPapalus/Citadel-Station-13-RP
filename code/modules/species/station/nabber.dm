...
//	blood_oxy = 0
	...
	icon_template = 'icons/mob/species/nabber/template.dmi'
	icobase = 'icons/mob/species/nabber/body.dmi'
	deform = 'icons/mob/species/nabber/body.dmi'
	preview_icon = 'icons/mob/species/nabber/preview.dmi'
	blood_mask = 'icons/mob/species/nabber/blood_mask.dmi'
