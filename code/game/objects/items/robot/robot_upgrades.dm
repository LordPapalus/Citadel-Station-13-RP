...
/obj/item/borg/upgrade/language/action(var/mob/living/silicon/robot/R)
	...
	R.add_language(LANGUAGE_BIRDSONG, 1)               //From this point onwards, languages migrated from upgrades_vr.dm - Papalus
	...
	//Robot resizing module, moved from upgrades_vr.dm - Papalus
